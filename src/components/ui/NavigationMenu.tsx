...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn(
      'sticky top-0 z-10 flex flex-1 items-center justify-center border border-b-neutral-300 py-2 dark:border-b-neutral-400',
      className
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.List
    ref={ref}
    className={cn(
      'group container flex w-screen flex-1 list-none items-center justify-between',
      className
    )}
    {...props}
  />
